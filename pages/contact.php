<?php
$page_title = 'Kontak - Prohaba Jaya Mandiri';
$breadcrumb = [
...
<main>
  <section id="contact" class="py-5" style="background: linear-gradient(135deg, #f8fafb 0%, #e8f5f1 100%);" data-aos="fade-up">
    <div class="container">
      <div class="section-title text-center mb-5" data-aos="fade-up">
        <h2 class="fw-bold mb-2"><i class="bi bi-envelope-fill text-primary me-2"></i>Hubungi Kami</h2>
        <p class="text-muted">Silakan hubungi kami untuk informasi lebih lanjut, konsultasi, atau kerjasama proyek.</p>
      </div>
      ...
      <div class="row g-4 align-items-stretch">
        <div class="col-lg-5 d-flex">
          <div class="card shadow-lg border-0 rounded-4 p-4 w-100 h-100 mb-4 mb-lg-0" data-aos="fade-up" data-aos-delay="200">
            <div class="mb-4">
        ...
        <div class="col-lg-7 d-flex">
          <div class="card shadow-lg border-0 rounded-4 p-4 w-100 h-100" data-aos="fade-up" data-aos-delay="300">
            <form action="/pjm/forms/contact.php" method="post" class="php-email-form" autocomplete="off">
              <div class="row gy-4">
                <div class="col-md-6">
