<?php
$page_title = 'Tentang Kami - Prohaba Jaya Mandiri';
$breadcrumb = [
...
<section class="page-header py-4 bg-white border-bottom mb-4">
  <div class="container">
    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-2">
      <h1 class="h3 fw-bold mb-0 text-primary"><i class="bi bi-info-circle me-2"></i>Tentang Kami</h1>
          ...
          <div class="card shadow-lg border-0 rounded-4 p-4 bg-white">
            <div class="row gy-5 align-items-center">
              ...
              <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                <img src="/pjm/assets/img/prohaba-tentang-kami.jpg" class="img-fluid rounded-3" alt="Tentang Prohaba Jaya Mandiri">
              </div>
            </div>
          </div>
  ...
  <section id="faq" class="faq-section section bg-gradient-faq py-5">
    <div class="container">
      <div class="section-title text-center mb-4" data-aos="fade-up">
        ...
        <p class="text-muted">Informasi singkat mengenai layanan dan proses kerja kami.</p>
      </div>
            ...
            <div class="accordion-item">
              <h3 class="accordion-header" id="faq-heading-1">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-collapse-1" aria-expanded="false" aria-controls="faq-collapse-1">
                  <i class="bi bi-patch-question text-primary me-2"></i>Bagaimana cara PROHABA memastikan kualitas proyek?
                </button>
              </h3>
              <div id="faq-collapse-1" class="accordion-collapse collapse" aria-labelledby="faq-heading-1" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  Kami menerapkan Sistem Manajemen Mutu <strong>ISO 9001:2015</strong> dan melakukan inspeksi kualitas di setiap tahap proyek untuk memastikan standar tertinggi terpenuhi.
                </div>
              </div>
            </div>
            <div class="accordion-item">
              <h3 class="accordion-header" id="faq-heading-2">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-collapse-2" aria-expanded="false" aria-controls="faq-collapse-2">
                  <i class="bi bi-patch-question text-primary me-2"></i>Apakah perusahaan menyediakan konsultasi gratis?
                </button>
              </h3>
              <div id="faq-collapse-2" class="accordion-collapse collapse" aria-labelledby="faq-heading-2" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  Ya, kami menyediakan <strong>konsultasi awal gratis</strong> untuk memahami kebutuhan klien dan menawarkan solusi terbaik sebelum memulai proyek.
                </div>
              </div>
            </div>
            <div class="accordion-item">
              <h3 class="accordion-header" id="faq-heading-3">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-collapse-3" aria-expanded="false" aria-controls="faq-collapse-3">
                  <i class="bi bi-patch-question text-primary me-2"></i>Bagaimana PROHABA menjaga keselamatan kerja di lapangan?
                </button>
              </h3>
              <div id="faq-collapse-3" class="accordion-collapse collapse" aria-labelledby="faq-heading-3" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  Kami menerapkan Sistem Manajemen K3 <strong>ISO 45001:2018</strong>, pelatihan rutin, dan audit keselamatan berkala untuk memastikan lingkungan kerja yang aman bagi semua.
                </div>
              </div>
            </div>
          </div>
